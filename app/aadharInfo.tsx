        ...
        <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.header}>
                ...
                <TouchableOpacity onPress={() => router.back()} style={styles.backButton}>
                    ...
                    <Text style={styles.headerTitle}>Aadhar </Text>
                </TouchableOpacity>
            ...
            <View style={styles.cardContainer}>
                <View style={styles.verificationBox}>
                    ...
                    <Text style={styles.verifiedText}>Your Aadhar Card is verified</Text>
                    <View style={styles.aadharBox}>
                        
                        <Text style={styles.aadharNumber}>74697202XXXX</Text>
                    </View>
                    <Text style={styles.verifiedOn}>Verified on</Text>
                    <TouchableOpacity style={styles.viewButton}>
                        <Text style={styles.viewButtonText}>View Aadhar Card</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </SafeAreaView>
